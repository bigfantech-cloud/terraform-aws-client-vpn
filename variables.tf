...
variable "saml_metadata_document" {
  description = "SAML metadata XML document for Client VPN authentication, generated by an identity provider that supports SAML 2.0"
  type        = string
}

variable "saml_self_service_metadata_document" {
  description = "SAML metadata XML document for Client VPN Self Service, generated by an identity provider that supports SAML 2.0"
  type        = string
  default     = null
}
